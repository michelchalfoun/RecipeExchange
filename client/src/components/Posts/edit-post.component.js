...
function CreatePost() {
    ...
    const onSubmit = (e) => {
        ...
        axios.put('/posts/update/' + postID, postInfo)
            .then((res) => {
        ...
        <div className="wrapper">
            <form onSubmit={onSubmit}>
                ...
                <div className="form-group2">
                    ...
                    <textarea value={postInfo.ingredients} onChange={e => setPostInfo({ ...postInfo, ingredients: e.target.value })} className="longtextbox" required />
                </div>
                ...
                <div className="form-group2">
                    ...
                    <textarea value={postInfo.img} onChange={e => setPostInfo({ ...postInfo, img: e.target.value })} className="longtextbox" required />
                </div>
                ...
                {/*Submit*/}
                <div className="form-group">
                    <input type="submit" value="Update Recipe" className="bttn" />
                </div>
            </form>
            {successMsg &&
                <a class="ui green label">Your recipe was successfully updated!</a>
            }
            {failMsg &&
                <a class="ui red label">Your recipe was not successfully updated!</a>
            }
        </div>
